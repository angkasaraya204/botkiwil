...
exports.textTnC = () => {
    return `
Best regards, xKiwilx.`
}

exports.textmenupenting = (pushname) => {
    return `
Hi Kak ${pushname}👋️, selamatt datang di xKiwilxBot WhatsApp pintar yang siap membantumu.
Berikut fitur yang dapat di gunakan pada bot ini

List menu penting xKiwilxbot:

Silahkan Yang ingin mendapatkan info xKiwilxbot lebih cepat ketik 
${prefix}grup
tapi gk usah keluar masuk grup ya :)

🚀 *${prefix}addbacot*
Untuk melihat bacotan member xKiwilxbot
...
🚀 *${prefix}listbacot*
Untuk melihat list bacotan member xKiwilxbot
...
17. *${prefix}apakah*
Menanyakan sesuatu ke xKiwilxbot
...
exports.textsongmenu = (pushname) => {
   return `
Hi Kak ${pushname}👋️, sSelamat datang di xKiwilxBot WhatsApp pintar yang siap membantumu.
Berikut fitur yang dapat di gunakan pada bot ini

List lagu xKiwilxbot:
...
*Ketik /chat* 
*Untuk Mengobrol dengan xKiwilxbot*
*Jika ingin membuat sticker atau menu lainnya silahkan di offkan xKiwilxbot chatnya*

List menu:

1. *${prefix}menupenting*
Menampilkan menu penting di xKiwilxbot
Usage: ketik */menupenting*

2. *${prefix}menuhiburan*
Menampilkan menu hiburan di xKiwilxbot
Usage: ketik */menuhiburan*

3. *${prefix}mentol*
Menampilkan menu tools & alat di xKiwilxbot
Usage: ketik */mentol*
...
10. *${prefix}lagu*
Menampilan album lagu xKiwilxbot
Usage: ketik */lagu*
...
exports.textmenubaru = (pushname) => {
    ...
    │
    ├─ ❏ tebakgambar[otw]
    ├─ ❏ nextkuiz (tebak gambar)[otw]
    ├─ ❏ stopkuiz (tebak gambar)[otw]
    ├─ ❏ caklontong[otw]
    ├─ ❏ tod
    └─ ❏ kuismtk
    └─ ❏ susunkata[otw]
...
xKiwilxBot terdapat 2 menu sekarang

🐳 *${prefix}menubaru* 🐳
🐳 *${prefix}𝚖𝚎𝚗𝚞lama* 🐳

Jam: *${tod}*
Total user xKiwilxBot : ${coloo.length}

Jika tulisan tidak keliatan kek kotak kotak 
Ketik /help

Untuk melihat Waktu xKiwilxBot Aktif
...
Total user xKiwilxBot : ${contol.length}
...
List menu wibuarea di xKiwilxbot:
...
exports.menusticker = (pushname) => {
    return `
Hi Kak ${pushname}👋️, Selamat datang di xKiwilxBot WhatsApp pintar yang siap membantumu.
...
Contoh: /galaxytext xKiwilxbot

10. *${prefix}glowtext*
Untuk membuat glowtext
Usage: ketik /glowtext teksnya
Contoh: /glowtext xKiwilxbot
...
exports.textAdmin = () => {
    return `
⚠ [ *Admin Group Only* ] ⚠ 
Berikut adalah fitur admin grup yang ada pada ❣ *xKiwilxBot* ❣!
...
⚠ [ *Owner Group Only* ] ⚠
Berikut adalah fitur owner grup yang ada pada ❣ *xKiwilxBot* ❣!
🐼 *${prefix}kickall*
